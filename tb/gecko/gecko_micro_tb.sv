...
#(
    ...
    initial begin
        ...
        fork
            begin
                axi_ar.send('h0, AXI4_BURST_INCR, axi4_cache_t'(4'b0), 'h0, AXI4_LOCK_NORMAL, axi4_prot_t'(3'b0), 'b0,
                            'h2, 'b0, 'b0);
                // axi_ar.send('h4, 
                //         AXI4_BURST_INCR, 
                //         axi4_cache_t'(4'b0), 
                ...
                axi_aw.send('h0, AXI4_BURST_INCR, axi4_cache_t'(4'b0), 'h0, AXI4_LOCK_NORMAL, axi4_prot_t'(3'b0), 'b0,
                            'h2, 'b0, 'b0);
