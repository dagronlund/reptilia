    ...
    generate
        if (PIPELINE_MODE == STREAM_PIPELINE_MODE_TRANSPARENT) begin
            ...
            std_register #(
                ...
                .clk,
                .rst(std_get_reset(CLOCK_INFO, 0)),
            ...
            always_comb begin
                ...
                enable_valid0 = (input_index_enable && !input_index) || (output_index_enable && !output_index);
                enable_valid1 = (input_index_enable && input_index) || (output_index_enable && output_index);
            end
