...
RustdvTest(
    ...
    top="mem_sequential_single_tb_wrapper",
    files=(
        "rtl/mem/mem_sequential_single.sv",
        "rtl/mem/mem_stage.sv",
    ),
    wrapper="rtl/mem/test/rtl/mem_sequential_single_tb_wrapper.sv",
)
...
RustdvTest(
    ...
    top="mem_sequential_double_tb_wrapper",
    files=("rtl/mem/mem_sequential_double.sv",),
    wrapper="rtl/mem/test/rtl/mem_sequential_double_tb_wrapper.sv",
)
...
RustdvTest(
    ...
    top="mem_sequential_read_write_tb_wrapper",
    files=("rtl/mem/mem_sequential_read_write.sv",),
    wrapper="rtl/mem/test/rtl/mem_sequential_read_write_tb_wrapper.sv",
)
...
RustdvTest(
    ...
    top="mem_split_merge_tb_wrapper",
    files=("rtl/mem/mem_merge.sv", "rtl/mem/mem_split.sv"),
    wrapper="rtl/mem/test/rtl/mem_split_merge_tb_wrapper.sv",
)
