...
package fpu_mult_pkg;
    ...
    function automatic fpu_mult_exp_result_t fpu_float_mult_exponent(
        ...
        b,
        input fpu_float_conditions_t conditions_A,
        conditions_B,
        // input logic valid, 
        ...
        result.infinity = conditions_A.infinity || conditions_B.infinity || overflow;
    ...
    function automatic logic [47:0] fpu_float_mult_multiply(input logic [23:0] a, b);
        return a * b;
    endfunction

    function automatic fpu_mult_op_result_t fpu_float_mult_operation(input fpu_mult_exp_result_t exp_result);
        ...
        result.infinity = exp_result.infinity;
        result.nan = exp_result.nan;

        return result;
    endfunction

    function automatic fpu_result_t fpu_float_mult_normalize(input fpu_mult_op_result_t y);
        ...
        result.nan = y.nan;
        result.infinity = y.infinity || overflow;
        result.zero = y.zero;
        result.mode = y.mode;
