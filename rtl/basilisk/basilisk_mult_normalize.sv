...
#(
    ...
    std_stream_intf #(
        .T(basilisk_result_t)
    ) next_mult_result_command (
        .clk,
        .rst
    );
    std_stream_intf #(
        .T(basilisk_mult_add_normalize_command_t)
    ) next_mult_add_normalize_command (
        .clk,
        .rst
    );
    ...
    std_flow_lite #(
        ...
        .consume,
        .produce({produce_result, produce_macc}),
        .enable
    );
    ...
    std_flow_stage #(
        ...
        .clk,
        .rst,
        .stream_in (next_mult_result_command),
        .stream_out(mult_result_command)
    );
    ...
    std_flow_stage #(
        ...
        .clk,
        .rst,
        .stream_in (next_mult_add_normalize_command),
        .stream_out(mult_add_normalize_command)
    );
    ...
    always_comb begin
        ...
        next_mult_result_command.payload.result = fpu_float_mult_normalize(mult_operation_command.payload.result);
