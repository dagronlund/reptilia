...
package basilisk_decode_util_pkg;
    ...
    function automatic logic basilisk_decode_depend_rd(input rv32_fields_t inst_fields);
        case (rv32f_opcode_t'(inst_fields.opcode))
            RV32F_OPCODE_FLW: return 'b1;
            RV32F_OPCODE_FSW: return 'b0;
            RV32F_OPCODE_FMADD_S, RV32F_OPCODE_FMSUB_S, RV32F_OPCODE_FNMSUB_S, RV32F_OPCODE_FNMADD_S: return 'b1;
    ...
    function automatic logic basilisk_decode_depend_rs1(input rv32_fields_t inst_fields);
        case (rv32f_opcode_t'(inst_fields.opcode))
    ...
    function automatic logic basilisk_decode_depend_rs2(input rv32_fields_t inst_fields);
        case (rv32f_opcode_t'(inst_fields.opcode))
            RV32F_OPCODE_FLW: return 'b0;
            ...
            RV32F_OPCODE_FP_OP_S: begin
                case (rv32f_funct7_t'(inst_fields.funct7))
                    RV32F_FUNCT7_FADD_S, RV32F_FUNCT7_FSUB_S, 
            RV32F_FUNCT7_FMUL_S, RV32F_FUNCT7_FDIV_S, 
            RV32F_FUNCT7_FSGNJ_S, RV32F_FUNCT7_FMIN_MAX_S:
                    return 'b1;
    ...
    function automatic logic basilisk_decode_depend_rs3(input rv32_fields_t inst_fields);
        case (rv32f_opcode_t'(inst_fields.opcode))
            RV32F_OPCODE_FMADD_S, RV32F_OPCODE_FMSUB_S, RV32F_OPCODE_FNMSUB_S, RV32F_OPCODE_FNMADD_S: return 'b1;
        endcase
    ...
    function automatic logic basilisk_decode_depend_registers(input rv32_fields_t inst_fields, input logic rd_status,
                                                              rs1_status, rs2_status, rs3_status
