...
#(
    ...
    std_flow_stage #(
        ...
        .clk,
        .rst,
        .stream_in (next_sqrt_result_command),
        .stream_out(sqrt_result_command)
    );
    ...
    always_comb begin
        ...
        next_sqrt_result_command.payload.result = fpu_float_sqrt_normalize(sqrt_operation_command.payload.result);
    end
