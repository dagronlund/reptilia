...
#(
    ...
    std_flow_stage #(
        ...
        .clk,
        .rst,
        .stream_in (next_mult_operation_command),
        .stream_out(mult_operation_command)
    );
    ...
    always_comb begin
        ...
        next_mult_operation_command.payload.result = fpu_float_mult_operation(mult_exponent_command.payload.result);
