...
#(
    ...
    std_flow_lite #(
        ...
        .consume,
        .produce({produce_request, produce_partial_result}),
        .enable
    );
    ...
    std_flow_stage #(
        ...
        .clk,
        .rst,
        .stream_in (next_partial_memory_result),
        .stream_out(partial_memory_result)
    );
    ...
    mem_stage #(
        ...
        .clk,
        .rst,
        .mem_in (next_memory_request),
        .mem_out(memory_request)
    );
