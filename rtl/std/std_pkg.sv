...
package std_pkg;
    ...
    function automatic logic std_is_reset_active(input std_clock_info_t clk_info, input logic rst);
    ...
    function automatic logic std_get_reset(input std_clock_info_t clk_info, input logic is_active);
        if (clk_info.reset_polarity == STD_RESET_POLARITY_HIGH) begin
            return is_active;
        end else begin
            return !is_active;
